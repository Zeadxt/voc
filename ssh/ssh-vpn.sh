...
curl ${url}/ssh/nginx.conf > /etc/nginx/nginx.conf
curl ${url}/ssh/vps.conf > /etc/nginx/conf.d/vps.conf
...
wget -O /home/vps/public_html/index.html "${url}/ssh/index.html1"
...
#OpenVPN
wget ${url}/ssh/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
...
# Ganti Banner
wget -O /etc/issue.net "${url}/ssh/issue.net"
...
wget -O insshws "${url}/sshws/insshws.sh"
wget -O issue "${url}/ssh/issue.net"
wget -O webmin "${url}/ssh/webmin.sh"
# menu system
...
wget -O m-update "${url}/menu/m-update.sh"
wget -O m-theme "${url}/menu/m-theme.sh"
wget -O speedtest "${url}/ssh/speedtest_cli.py"
wget -O swapkvm "${url}/ssh/swapkvm.sh"
...
wget -O slhost "${url}/ssh/slhost.sh""
