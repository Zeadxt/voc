...
echo ""
echo -ne "\033[1;33mTERMUX COMMAND:\033[0m curl -sO https://github.com/Tarap-Kuhing/Slowdns/raw/main/files/slowdns && chmod +x slowdns && ./slowdns " && cat /etc/slowdns/infons /root/server.pub
echo ""
...
cd
rm server.key server.pub
wget https://raw.githubusercontent.com/Tarap-Kuhing/SLDNS/main/slowdns/server.key
wget https://raw.githubusercontent.com/Tarap-Kuhing/SLDNS/main/slowdns/server.pub
sleep 1
